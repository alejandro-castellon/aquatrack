import DarkWrapper from "@/components/ui/home/dark-gradient";
  ...
  const features = [
    {
      ...
      title: "Elaboración de medidores inteligentes",
      desc: "Instalación sencilla de medidores inteligentes para un control efectivo.",
    },
    {
      icon: (
        <svg
      ...
      desc: "Con Aquatrack, puedes medir y gestionar tu consumo de agua de manera eficiente.",
    },
    {
      icon: (
        <svg
      ...
      desc: "Conoce tus hábitos de consumo y ahorra en tus facturas de agua.",
    },
    {
      icon: (
        <svg
      ...
      desc: "Disfruta de la comodidad de la conectividad inalámbrica en cada medidor para una experiencia sin complicaciones.",
    },
  ];

  return (
    <DarkWrapper id="servicios">
      <div className="custom-screen text-gray-300 justify-between gap-24 lg:flex">
        <div className="max-w-xl">
          ...
          <p className="mt-3">
            Aquatrack te proporciona información en tiempo real sobre tu consumo
            de agua. Con nuestra app, puedes controlar fácilmente tu consumo y
            ahorrar en tu factura de agua.
          </p>
        </div>
