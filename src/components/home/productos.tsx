      ...
      <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center">
        <div className="flex-none max-w-xl mt-12 space-y-3 md:mt-0">
          <h2 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
            Elaboramos medidores inteligentes de acuerdo a tus necesidades.
          </h2>
          <p className="text-gray-600">
            Aquatrack permite a los inquilinos monitorear su consumo de agua en
            tiempo real, promoviendo el ahorro y la sostenibilidad. Los
            administradores de edificios pueden gestionar el uso de recursos de
